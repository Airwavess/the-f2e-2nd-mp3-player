const musicDB = [
  ...
  { name: 'tomorrow', time: '4:54', album: 'acoustic', artist: 'someoneB' },
  { name: 'ukulele', time: '2:26', album: 'acoustic', artist: 'someoneB' },
  { name: 'cute', time: '3:14', album: 'acoustic', artist: 'someoneB' },
  {
    name: 'acousticbreeze',
    time: '2:37',
    album: 'acoustic',
